...
public:
    ...
    int sendPostRequest(const QString &strUrl, const QByteArray &data, const QMap<QString, QString> &map, QString &response);
    int sendGetRequest(const QString &strUrl, QString &response);
    int sendGetRequest(const QString &strUrl, const QMap<QString, QString> &map, QString &response);
};
